        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">
              Analyze developers, compare metrics, and chat with codebases
            </p>
          </div>
        </div>

        {/* Top Dark Blue Navigation Tabs */}
        <nav className="flex items-center gap-1 bg-slate-800/80 p-1 rounded-lg border border-slate-700/60">
          <button
            onClick={() => onTabChange("explorer")}
            className={`px-3.5 py-1.5 rounded-md font-medium text-xs transition-all flex items-center gap-2 ${
              activeTab === "explorer"
